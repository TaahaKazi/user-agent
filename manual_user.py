...
def main():
    ...
    DATA_PATH = 'folder/user-agent/multiwoz/data/MultiWOZ_2.1/data.json'
    REFERENCE_LIST_FILE = 'folder/user-agent/multiwoz/data/MultiWOZ_2.1/valListFile.txt'
    ...
    output_file = 'output_' + datetime.datetime.now().strftime("%Y-%m-%d-%H-%M-%S") + '.jsonl'
